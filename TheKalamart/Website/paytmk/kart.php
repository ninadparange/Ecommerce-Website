                ...
                <form method="post" action="pgRedirect.php">
                    ...
                    <div class="row">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <tr>
                                    <td class="col-md-9"><explosion-box 1</em></h4></td>
                                    <td class="col-md-1" style="text-align: center"> 1 </td>
                                    <td class="col-md-1 text-center">Rs.2000</td>
                                    <td class="col-md-1 text-center">Rs.2000</td>
                                </tr>
                                <tr>
                                    <td class="col-md-9"><em>explosion-box 2</em></h4></td>
                                    <td class="col-md-1" style="text-align: center"> 1 </td>
                                    <td class="col-md-1 text-center">Rs.1500</td>
                                    <td class="col-md-1 text-center">Rs.1500</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center text-danger">
                                        <h4><strong><input title="TXN_AMOUNT" tabindex="10" type="text" name="TXN_AMOUNT" value="3500" size="3" style="border: none;background: #f5f5f5" ></strong></h4>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
